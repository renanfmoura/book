...
Outra identidade que usaremos como exemplo aqui é a Lei de Absorção: $A \cup (A \cap B) = A$

No template abaixo temos duas formas de escrever a prova: a que estamos utilizando; e em forma de lógica booleana, trocando o sinal de igual pelo de equivalência, ou ``se e somente se", ($\leftrightarrow$). (Você consegue reprentá-lo no Lean escrevendo: $\backslash$iff)
